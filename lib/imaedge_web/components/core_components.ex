defmodule ImaedgeWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(ImaedgeWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(ImaedgeWeb.Gettext, "errors", msg, opts)
    end
  end
